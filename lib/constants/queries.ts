...
export const CANDIDATE_DETAIL_COLUMNS =
  "id, full_name, email, phone, cv_storage_path, public_tracking_token, pipeline_stage, stage_entered_at, job_id, created_at, scores(*), jobs(title, requirements), interviews(id, scheduled_at, rating, notes, approved, evaluator_id, created_at, updated_at), candidate_offers(id, base_salary, bonus, proposed_start_date, internal_approval_notes, status, updated_at)";
